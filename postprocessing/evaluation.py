...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Pixel-level evaluation of segmentation / classification runs."
    )
    parser.add_argument(
        "--seg-run-ids",
        nargs="*",
        default=[],
        help="MLflow run IDs with segmentation masks.",
    )
    parser.add_argument(
        "--cls-run-ids",
        nargs="*",
        default=[],
        help="MLflow run IDs with classification heatmaps.",
    )
    args = parser.parse_args()
    main(seg_run_ids=args.seg_run_ids, cls_run_ids=args.cls_run_ids)
