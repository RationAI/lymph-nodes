...
from lymph_nodes.ml.metrics import MetricDictionary


logger = logging.getLogger("pipeline_module")


class PipelineModule(lightning.pytorch.LightningModule):
    """PipelineModule.

    PipelineModule assembles result mode lymph_nodes for training or testing.
    The class takes the model, output activation function, loss function, optimizer,
    learning rate schedule, and metrics and creates the final lymph_nodes.
    """
